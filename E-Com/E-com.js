let icon = document.querySelector(".icon"); //let is used to asign a variable in js
let ul = document.querySelector("ul");

icon.addEventListener("click", ()=>{ // to make a meaningful function when clicked on this id a certain task will occur 
...
let shops = document.getElementById("shops");  //  to select the variable 
